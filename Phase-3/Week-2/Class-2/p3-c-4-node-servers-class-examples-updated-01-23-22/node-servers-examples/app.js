// // 1: Creating basic Web Server and 
////Serving simple message using the http 
//module by handling request and response
...
//   res.end("Hello There!");// by end method!
// });
...
// 3. Serving static page with http module
 const http = require("http");
 const url = require("url");//to check the real path
 const fs = require("fs");//to read contents
